...
function AboutUsPage() {
  ...
  return (
    <div>
      ...
      <img src="/front-end/public/learniverse_connect_icon2.svg" alt="Logo" class="logo"></img>
      <hr></hr>
      <p>Learniverse Connect is an online course marketplace dedicated to facilitating lifelong 
        ...
        <br></br><br></br>
        Our platform is committed to quality, with curated course offerings designed to deliver 
        ...
        <br></br><br></br>
        Join our community of learners and explore the opportunities for growth and enrichment 
