...
/**
 * Repository interface for accessing and managing FavoriteCourse entities in the database.
 * This interface extends JpaRepository, providing CRUD functionality for FavoriteCourse entities.
 * 
 * @version 22.05.2024
 * @author Group 01
 */
...
public interface FavoriteCourseRepository extends JpaRepository<FavoriteCourse, Integer> {
     ...
     * @return the favorite course associated with the specified user ID and course ID
     */
